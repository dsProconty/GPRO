...
export async function PUT(request, { params }) {
  ...
  const { detalle, empresaId, valor, fechaCreacion, fechaCierre, estadoId, aplicativo, ot, projectOnline, estadoPropuesta, clienteIds = [], responsableIds = [] } = await request.json()
